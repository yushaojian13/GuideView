...
public class GuideBuilder {
    ...
    /**
     * Builder被创建后，不允许再对它进行更改
     */
    private boolean mBuilt;

    private Configuration               mConfiguration;                  // 遮罩配置
    private List<Component>             mComponents = new ArrayList<>(); // 额外说明组件
    private OnVisibilityChangedListener mOnVisibilityChangedListener;    // 遮罩可见性状态监听器
